      ...
      <Carousel>
        <div className="container portfolioPic">
          ...
          <div className="portfolioCard">
            ...
            <p className="portfolioBodyText">
              ...
              to teach children to responsibly do their chores. This was
              completed as my final project while attending the Coding Boot Camp
              at GA Tech.
            </p>
        ...
        <div className="container portfolioPic">
          ...
          <div className="portfolioCard">
            ...
            <p className="portfolioBodyText">
              Crystal Clarity was one of my first javascript assignments. It is
              a counting game, and a lot of fun to play!
              <br></br>
